...
str.isdigit() # Возвращает True, если строка s не пустая и содержит только символы ASCII, обозначающие цифры десятичной системы счисления. Для float и отрицательных значений вернет false
